...
export class RefreshTokenUseCase implements IRefreshTokenUseCase{
    constructor(@inject("ITokenService") private _ITokenService:ITokenService){}
     execute(refreshToken: string): { role: string; accessToken: string; } {
        const payload = this._ITokenService.verifyRefreshToken(refreshToken);
        ...
        return{
            ...
            accessToken:this._ITokenService.generateAccessToken({
