...
const CarCard: React.FC<CarCardProps> = ({
  ...
  return (
    <Link to={`/auction/${id}`} className="block group">
      <div className="overflow-hidden transition-all duration-300 rounded-lg bg-zinc-900 border border-zinc-800 hover:shadow-lg hover:shadow-[#3BE188]/20 h-80 w-full">
